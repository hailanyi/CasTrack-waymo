...
class Trajectory:
    ...
    def state_update(self,
        ...
        if self.consecutive_missed_num>1:
            ...
            current_ob.prediction_score = current_ob.prediction_score + self.config.prediction_score_decay*15*(score)
        else:
            current_ob.prediction_score = current_ob.prediction_score + self.config.prediction_score_decay*(score)
